...
if "$lang" == "en":
	...
	if "$chx" == "3":
		mkdir /tmp/vscript
		curl https://voxan24.github.io/Linux_Script/deb8to9.sh -o /tmp/vscript/deb8to9.sh.sh
...
if "lang" == "fr":
	...
	echo "Nombre de script disponible: 5"
	echo "1- Script de mise a niveaux de Debian 8 vers Debian 10 (deb8to10.sh)"
	echo "2- Script de mise a niveaux de Debian 9 vers Debian 10 (deb9to10.sh)"
	echo "3- Script de mise a niveaux de Debian 8 vers Debian 8 (deb8to9.sh)"
	echo "4- Script de mise a niveaux de CentOS 7 vers CentOS 8 (centos7to8.sh)"
	echo "5- Script d'installation d'une seedbox avec flood sous Debian 10 (seedbox_deb10_flood.sh)"
